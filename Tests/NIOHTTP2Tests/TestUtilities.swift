...
extension XCTestCase {
    ...
    func interactInMemory(
        ...
        func readBytesFromChannel(_ channel: NIOAsyncTestingChannel) async -> ByteBuffer? {
            try? await assertNoThrowWithValue(await channel.readOutbound(as: ByteBuffer.self))
        }
    ...
    func deliverAllBytes(
        from sourceChannel: EmbeddedChannel,
        to targetChannel: EmbeddedChannel,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        while case .some(.byteBuffer(var buf)) = try? assertNoThrowWithValue(
            sourceChannel.readOutbound(as: IOData.self)
        ) {
    ...
    func assertDoHandshake(
        client: EmbeddedChannel,
        server: EmbeddedChannel,
        clientSettings: [HTTP2Setting] = nioDefaultSettings,
        serverSettings: [HTTP2Setting] = nioDefaultSettings,
        file: StaticString = #filePath,
        line: UInt = #line
    ) throws {
        ...
        clientReceivedSettings.assertSettingsFrame(
            expectedSettings: serverSettings,
            ack: false,
            file: (file),
            line: line
        )
        serverReceivedSettings.assertSettingsFrame(
    ...
    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    func assertDoHandshake(
        client: NIOAsyncTestingChannel,
        server: NIOAsyncTestingChannel,
        clientSettings: [HTTP2Setting] = nioDefaultSettings,
        serverSettings: [HTTP2Setting] = nioDefaultSettings,
        file: StaticString = #filePath,
        line: UInt = #line
    ...
    @discardableResult
    func assertFramesRoundTrip(
        frames: [HTTP2Frame],
        sender: EmbeddedChannel,
        receiver: EmbeddedChannel,
        file: StaticString = #filePath,
        line: UInt = #line
    ) throws -> [HTTP2Frame] {
        for frame in frames {
    ...
    /// received.
    func assertSettingsUpdateWithAck(
        _ newSettings: HTTP2Settings,
        sender: EmbeddedChannel,
        receiver: EmbeddedChannel,
        file: StaticString = #filePath,
        line: UInt = #line
        ...
        try sender.assertReceivedFrame(file: (file), line: line).assertFrameMatches(
            this: HTTP2Frame(streamID: .rootStream, payload: .settings(.ack))
        )
    }
}
...
extension HTTP2Frame {
    ...
    func assertSettingsFrame(
        expectedSettings: [HTTP2Setting],
        ack: Bool,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        XCTAssertEqual(
            self.streamID,
            .rootStream,
            "Got unexpected stream ID for SETTINGS: \(self.streamID)",
            file: (file),
            line: line
        )
    ...
    func assertFrameMatches(
        this frame: HTTP2Frame,
        dataFileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        case .data:
            self.assertDataFrameMatches(
                this: frame,
                fileRegionToByteBuffer: dataFileRegionToByteBuffer,
                file: (file),
                line: line
            )
        case .goAway:
    ...
    func assertHeadersFrameMatches(this frame: HTTP2Frame, file: StaticString = #filePath, line: UInt = #line) {
        XCTAssertEqual(
            self.streamID,
            frame.streamID,
            "Unexpected streamID: expected \(streamID), got \(self.streamID)",
            file: (file),
            line: line
        )
    ...
    func assertHeadersFrame(
        ...
        self.payload.assertHeadersFramePayload(
            endStream: endStream,
            headers: headers,
            priority: priority,
            type: type,
    ...
    func assertDataFrameMatches(
        this frame: HTTP2Frame,
        fileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        XCTAssertEqual(
        ...
        self.payload.assertDataFramePayloadMatches(
            this: frame.payload,
            fileRegionToByteBuffer: fileRegionToByteBuffer,
            file: (file),
            line: line
        )
    }
    ...
    func assertGoAwayFrame(
        ...
        XCTAssertEqual(self.streamID, .rootStream, "Goaway frame must be on the root stream!", file: (file), line: line)
        self.payload.assertGoAwayFramePayload(
    ...
    func assertRstStreamFrameMatches(this frame: HTTP2Frame, file: StaticString = #filePath, line: UInt = #line) {
        XCTAssertEqual(
            self.streamID,
            frame.streamID,
            "Non matching stream IDs: expected \(streamID), got \(self.streamID)!",
            file: (file),
            line: line
        )
    ...
    func assertPriorityFrame(
        streamPriorityData: HTTP2Frame.StreamPriorityData,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        XCTAssertEqual(
    ...
    func assertPushPromiseFrame(
        streamID: HTTP2StreamID,
        pushedStreamID: HTTP2StreamID,
        headers: HPACKHeaders,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        self.payload.assertPushPromiseFramePayload(
            pushedStreamID: pushedStreamID,
            headers: headers,
            file: (file),
            line: line
        )
    ...
    func assertAlternativeServiceFrameMatches(
        this frame: HTTP2Frame,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        XCTAssertEqual(
            .rootStream,
            self.streamID,
            "ALTSVC frame must be on the root stream!, got \(self.streamID)!",
            file: (file),
            line: line
        )
    ...
    func assertAlternativeServiceFrame(
        origin: String?,
        field: ByteBuffer?,
        file: StaticString = #filePath,
        line: UInt = #line
    ...
    func assertOriginFrameMatches(this frame: HTTP2Frame, file: StaticString = #filePath, line: UInt = #line) {
        XCTAssertEqual(
            .rootStream,
            self.streamID,
            "ORIGIN frame must be on the root stream!, got \(self.streamID)!",
            file: (file),
            line: line
        )
...
extension HTTP2Frame.FramePayload {
    func assertFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        dataFileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        case .data:
            self.assertDataFramePayloadMatches(
                this: payload,
                fileRegionToByteBuffer: dataFileRegionToByteBuffer,
                file: (file),
                line: line
    ...
    /// Asserts that a given frame is a HEADERS frame matching this one.
    func assertHeadersFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        self.assertHeadersFramePayload(
            endStream: payload.endStream,
    ...
    func assertHeadersFramePayload(
        endStream: Bool,
        headers: HPACKHeaders,
        priority: HTTP2Frame.StreamPriorityData? = nil,
        ...
        XCTAssertEqual(
            actualPayload.endStream,
            endStream,
            "Unexpected endStream: expected \(endStream), got \(actualPayload.endStream)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            headers,
            actualPayload.headers,
            "Non-equal headers: expected \(headers), got \(actualPayload.headers)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            priority,
            actualPayload.priorityData,
            "Non-equal priorities: expected \(String(describing: priority)), got \(String(describing: actualPayload.priorityData))",
            file: (file),
            line: line
        )
        ...
        case .some(.request):
            XCTAssertNoThrow(
                try actualPayload.headers.validateRequestBlock(supportsExtendedConnect: true),
                "\(actualPayload.headers) not a valid \(type!) headers block",
                file: (file),
                line: line
            )
        case .some(.response):
            XCTAssertNoThrow(
                try actualPayload.headers.validateResponseBlock(),
                "\(actualPayload.headers) not a valid \(type!) headers block",
                file: (file),
                line: line
            )
        case .some(.trailers):
            XCTAssertNoThrow(
                try actualPayload.headers.validateTrailersBlock(),
                "\(actualPayload.headers) not a valid \(type!) headers block",
                file: (file),
                line: line
            )
        ...
        case .none:
            XCTAssertTrue(
                (try? actualPayload.headers.validateRequestBlock(supportsExtendedConnect: true)) != nil
    ...
    ///
    /// This function always converts the DATA frame to a bytebuffer, for use with round-trip testing.
    func assertDataFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        fileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
        ...
        case (.byteBuffer(let bufferPayload), _):
            self.assertDataFramePayload(
                endStream: actualPayload.endStream,
    ...
    func assertDataFramePayload(
        ...
        XCTAssertEqual(
            actualFrameBody.endStream,
            endStream,
            "Unexpected endStream: expected \(endStream), got \(actualFrameBody.endStream)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            actualPayload,
            payload,
            "Unexpected body: expected \(payload), got \(actualPayload)",
            file: (file),
            line: line
        )
    }
    ...
    func assertGoAwayFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertGoAwayFramePayload(
        ...
        XCTAssertEqual(
            lastStreamID,
            actualLastStreamID,
            "Unexpected last stream ID: expected \(lastStreamID), got \(actualLastStreamID)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            integerErrorCode,
            errorCode,
            "Unexpected error code: expected \(errorCode), got \(integerErrorCode)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            byteArrayOpaqueData,
            opaqueData,
            "Unexpected opaque data: expected \(String(describing: opaqueData)), got \(String(describing: byteArrayOpaqueData))",
            file: (file),
            line: line
        )
    }

    func assertPingFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertPingFramePayload(
        ack: Bool,
        opaqueData: HTTP2PingData,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        XCTAssertEqual(
            actualPingData,
            opaqueData,
            "Non-matching ping data: expected \(opaqueData), got \(actualPingData)",
            file: (file),
            line: line
        )
    }
    ...
    /// Asserts that the given frame is a SETTINGS frame.
    func assertSettingsFramePayload(
        expectedSettings: [HTTP2Setting],
        ack: Bool,
        file: StaticString = #filePath,
        line: UInt = #line
        ...
        case .ack:
            XCTAssertEqual(
                expectedSettings,
                [],
                "Got unexpected settings: expected \(expectedSettings), got []",
                file: (file),
                line: line
            )
        ...
        case .settings(let actualSettings):
            XCTAssertEqual(
                expectedSettings,
                actualSettings,
                "Got unexpected settings: expected \(expectedSettings), got \(actualSettings)",
                file: (file),
                line: line
            )
    ...
    func assertSettingsFramePayloadMatches(
        this framePayload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertWindowUpdateFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertRstStreamFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertRstStreamFramePayload(errorCode: HTTP2ErrorCode, file: StaticString = #filePath, line: UInt = #line) {
        ...
        XCTAssertEqual(
            actualErrorCode,
            errorCode,
            "Non-matching error-code: expected \(errorCode), got \(actualErrorCode)",
            file: (file),
            line: line
        )
    }

    func assertPriorityFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertPriorityFramePayload(
        streamPriorityData: HTTP2Frame.StreamPriorityData,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertPushPromiseFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
        ...
        self.assertPushPromiseFramePayload(
            pushedStreamID: payload.pushedStreamID,
            headers: payload.headers,
            file: (file),
            line: line
        )
    ...
    func assertPushPromiseFramePayload(
        pushedStreamID: HTTP2StreamID,
        headers: HPACKHeaders,
        file: StaticString = #filePath,
        line: UInt = #line
        ...
        XCTAssertEqual(
            pushedStreamID,
            actualPayload.pushedStreamID,
            "Non matching pushed stream IDs: expected \(pushedStreamID), got \(actualPayload.pushedStreamID)",
            file: (file),
            line: line
        )
        XCTAssertEqual(
            headers,
            actualPayload.headers,
            "Non matching pushed headers: expected \(headers), got \(actualPayload.headers)",
            file: (file),
            line: line
        )
    }

    func assertAlternativeServiceFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertAlternativeServiceFramePayload(
        origin: String?,
        field: ByteBuffer?,
        file: StaticString = #filePath,
        line: UInt = #line
    ...
    func assertOriginFramePayloadMatches(
        this payload: HTTP2Frame.FramePayload,
        file: StaticString = #filePath,
        line: UInt = #line
    ) {
    ...
    func assertOriginFramePayload(origins: [String], file: StaticString = #filePath, line: UInt = #line) {
        ...
        XCTAssertEqual(
            origins,
            actualPayload,
            "Non matching origins: expected \(origins), got \(actualPayload)",
            file: (file),
            line: line
        )
    }
...
extension Array where Element == HTTP2Frame {
    func assertFramesMatch<Candidate: Collection>(
        _ target: Candidate,
        dataFileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
    ) where Candidate.Element == HTTP2Frame {
        guard self.count == target.count else {
            XCTFail(
                "Different numbers of frames: expected \(target.count), got \(self.count)",
                file: (file),
                line: line
            )
            return
        ...
        for (expected, actual) in zip(target, self) {
            expected.assertFrameMatches(
                this: actual,
                dataFileRegionToByteBuffer: dataFileRegionToByteBuffer,
                file: (file),
                line: line
            )
        }
...
extension Array where Element == HTTP2Frame.FramePayload {
    func assertFramePayloadsMatch<Candidate: Collection>(
        _ target: Candidate,
        dataFileRegionToByteBuffer: Bool = true,
        file: StaticString = #filePath,
        line: UInt = #line
    ) where Candidate.Element == HTTP2Frame.FramePayload {
        guard self.count == target.count else {
            XCTFail(
                "Different numbers of frame payloads: expected \(target.count), got \(self.count)",
                file: (file),
                line: line
            )
            return
        ...
        for (expected, actual) in zip(target, self) {
            expected.assertFramePayloadMatches(
                this: actual,
                dataFileRegionToByteBuffer: dataFileRegionToByteBuffer,
                file: (file),
                line: line
