...
//===----------------------------------------------------------------------===//
//
// ConfiguringPipelineWithFramePayloadStreamsTests+XCTest.swift
//
import XCTest
...
extension ConfiguringPipelineWithFramePayloadStreamsTests {

   @available(*, deprecated, message: "not actually deprecated. Just deprecated to allow deprecated tests (which test deprecated functionality) without warnings")
   static var allTests : [(String, (ConfiguringPipelineWithFramePayloadStreamsTests) -> () throws -> Void)] {
      return [
