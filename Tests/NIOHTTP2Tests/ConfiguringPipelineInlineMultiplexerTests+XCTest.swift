...
//===----------------------------------------------------------------------===//
//
// ConfiguringPipelineInlineMultiplexerTests+XCTest.swift
//
import XCTest
...
extension ConfiguringPipelineInlineMultiplexerTests {

   @available(*, deprecated, message: "not actually deprecated. Just deprecated to allow deprecated tests (which test deprecated functionality) without warnings")
   static var allTests : [(String, (ConfiguringPipelineInlineMultiplexerTests) -> () throws -> Void)] {
      return [
