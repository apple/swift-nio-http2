...
//===----------------------------------------------------------------------===//
//
// CompoundOutboundBufferTest+XCTest.swift
//
import XCTest
...
extension CompoundOutboundBufferTest {
   ...
   static var allTests : [(String, (CompoundOutboundBufferTest) -> () throws -> Void)] {
      return [
                ...
                ("testSimpleOutboundStreamBuffering", testSimpleOutboundStreamBuffering),
                ("testSimpleFlowControlBuffering", testSimpleFlowControlBuffering),
                ("testConcurrentStreamErrorThrows", testConcurrentStreamErrorThrows),
